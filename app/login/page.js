...
export default function Login() {
  ...
  const containerStyle = {
    ...
    // More generous vertical padding on mobile so card doesn't butt up against edges
  ...
  const cardStyle = {
    ...
    padding: isNarrow ? "1.75rem 1.25rem" : "2.5rem",
    background: "var(--bg-secondary)",
    backdropFilter: "blur(12px)",
    borderRadius: isNarrow ? "1rem" : "1.5rem",
  ...
  const titleStyle = {
    marginTop: "0.5rem",
    textAlign: "center",
    fontSize: isNarrow ? "1.6rem" : "1.875rem",
    fontWeight: 800,
    color: "var(--text-primary)",
  ...
  const inputStyle = {
    ...
    // Slightly taller tap targets on mobile
    paddingTop: isNarrow ? "0.95rem" : "0.875rem",
    paddingBottom: isNarrow ? "0.95rem" : "0.875rem",
    border: "1px solid var(--border-color)",
    background: "var(--bg-tertiary)",
    color: "var(--text-primary)",
    borderRadius: "0.75rem",
  ...
  const buttonStyle = {
    ...
    paddingTop: isNarrow ? "1rem" : "0.875rem",
    paddingBottom: isNarrow ? "1rem" : "0.875rem",
    paddingLeft: "1rem",
    paddingRight: "1rem",
    border: "none",
    fontSize: "0.95rem",
  ...
  const dividerStyle = { position: "relative", marginTop: "1.75rem" };

  const dividerLineStyle = { display: "flex", alignItems: "center" };
  ...
  const socialButtonStyle = {
    ...
    justifyContent: "center",
    gap: "0.5rem",
    paddingTop: isNarrow ? "0.875rem" : "0.625rem",
    paddingBottom: isNarrow ? "0.875rem" : "0.625rem",
    paddingLeft: "1rem",
    paddingRight: "1rem",
    border: "1px solid var(--border-color)",
    borderRadius: "0.75rem",
  ...
  const footerTextStyle = { fontSize: "0.875rem", color: "var(--text-muted)" };
  ...
  return (
    <main style={containerStyle}>
      <div style={{ ...glowStyle, top: "-10%", left: "-10%", width: "40%", height: "40%", background: "radial-gradient(circle, rgba(2, 132, 199, 0.2), transparent 80%)" }} />
      ...
      <div style={cardStyle}>
        ...
        <div style={brandHeaderStyle}>
          ...
          <p style={subtitleStyle}>
            ...
            <span style={{ color: "var(--accent-primary)", fontWeight: 600 }}>DevConnect AI</span>
          </p>
        </div>

        {error && (
          <div style={{ marginTop: "1.5rem", ...errorStyle }}>
            <span>⚠</span> {error}
          </div>
        )}
        ...
        <div style={gridStyle}>
          <button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.background = "var(--accent-primary-alpha)"; }}
            onMouseLeave={(e) => { e.currentTarget.style.background = "var(--bg-tertiary)"; }}
          >
        ...
        <div style={footerStyle}>
          <p style={footerTextStyle}>
            ...
            <Link href="/signup" style={footerLinkStyle}>Sign up</Link>
          </p>
        </div>
      </div>
    </main>
